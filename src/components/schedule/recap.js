...
export const Recap = () => {
    ...
    if (media.content === null || media.content.content.editorial.recap.items[0] === undefined || media.content.content.editorial === undefined ||  media.content.content.editorial.recap.items[0].media.playbacks === undefined) {
        return <>{media.content.content.editorial.recap.items.map((item) => {
            return (
                <div id="recap-container">
                   <h1>{item.headline}</h1>
                   <p>{item.seoDescription}</p>
                   <img id="recap-img" src={item.media.image.cuts['768x432'].src}  alt="recap"/>
    ...
    return (
        <div id="recap-container">
            ...
            <video controls id="recap-video" key={media.content.content.editorial.recap.items[0].media.playbacks[2].url} width={media.content.content.editorial.recap.items[0].media.playbacks[2].width} height={media.content.content.editorial.recap.items[0].media.playbacks[2].height} playsInline>
        ...
        {media.content.content.highlights.scoreboard.items.map((highlight) => {
            return (
                <div className="highlight-div">
                                        <video key = {highlight.playbacks[0].url} width={highlight.playbacks[0].width} height={highlight.playbacks[0].height} controls playsInline >
