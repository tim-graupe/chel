    ...
    return (
      ...
      <div id="home-page">
        <div id="news-container">
          {news.map((article) => {
          return (
            <div className="homepage-links-cards" key={article.headline}>            <a href={article.links.web.short.href}>
              <img src={article.images[0].url} alt ={article.images[0].alt} className="home-article-images" />
